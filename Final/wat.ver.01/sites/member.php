...
<head>
	...
	<style type="text/css">
		...
		.warning{font-family: 'watVivaldi'; font-size: 25px; color: #a8a8a8; margin-top: 10vh; outline: 1px solid red}
		.success{font-family: 'watVivaldi'; font-size: 25px; color: #a8a8a8; margin-top: 10vh; outline: 1px solid green}
...
<body>
	<div class="container">
		<p class="wat"> #wat </p>
		<form method="POST" action="member_check.php" onsubmit="return checkFrm(this)">
			<input type="text" name="username" class="username" placeholder="username" autocomplete="off">
			<input type="password" name="password" class="password" placeholder="password">
			<button type="submit" class="sbm"> sign in </button>
		</form>
		<a class="signup" href="member_new.php"> sign up? </a>

		<?php
		if(isset($_GET['warn']))
			echo '<p class="warning"> username or password is not correct </p>';
